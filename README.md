...
In 2015, data journalist **Walt Hickey** at FiveThirtyEight noticed something suspicious. Fandango is a platform that *both reviews movies AND sells tickets for them* but it seemed to be rating films unusually high. Almost suspiciously high.
...
This project sets out to answer that very question, and of course, with data.
